...
// Source: github.com/520wheat/simplebank/db/sqlc (interfaces: Store)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination db/mock/store.go github.com/520wheat/simplebank/db/sqlc Store
//
...
import (
	...
	sqlc "github.com/520wheat/simplebank/db/sqlc"
...
func (m *MockStore) GetVerifyEmail(ctx context.Context, id int64) (sqlc.VerifyEmail, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateUserPassword(ctx context.Context, arg sqlc.UpdateUserPasswordParams) (sqlc.User, error) {
	m.ctrl.T.Helper()
